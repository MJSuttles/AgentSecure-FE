...
//   // Preload vendors and populate form if editing
//   useEffect(() => {
...
//     if (obj.id) {
//       setFormInput(obj); // populate form if editing
//     }
//   }, [obj]);
...
//     e.preventDefault();
//     const payload = {
//       userId: user.uid, // pulled from auth context
...
//     } else {
//       createLogin(payload).then(() => router.push('/logins'));
//     }
//   };
...
//             checked={formInput.trainingComplete}
//             onChange={handleChange}
//           />
//         </Form.Group>
