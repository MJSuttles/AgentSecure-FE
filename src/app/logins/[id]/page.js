...
export default function ViewLogin({ params }) {
  ...
  return (
    <div className="text-center my-3">
      ...
      <svg onClick={handleDelete} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-trash3" viewBox="0 0 16 16" style={{ cursor: 'pointer' }}>
